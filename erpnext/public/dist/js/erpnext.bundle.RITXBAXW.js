(() => {
  ...
  // frappe-html:/home/mina/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_selector.html
...
`;
  ...
  // frappe-html:/home/mina/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_quick_entry.html
...
`;
          ...
          callback: function(r) {
            if (Object.prototype.toString.call(r.message) == "[object Object]") {
              ...
              var msgprint_dialog = frappe.msgprint(__("Item Variant {0} already exists with same attributes", [
                repl('<a class="strong variant-click" data-item-code="%(item)s" 								>%(item)s</a>', {
                  item: r.message
                })
              ]));
  ...
  // frappe-html:/home/mina/frappe-bench/apps/erpnext/erpnext/public/js/templates/call_link.html
...
`;
  ...
  // frappe-html:/home/mina/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_activities.html
...
.form-footer {
  ...
  // frappe-html:/home/mina/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_notes.html
...
//# sourceMappingURL=erpnext.bundle.RITXBAXW.js.map
